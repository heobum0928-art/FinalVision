...
namespace FinalVisionProject.Device {
    ...
    public class DisplayConfig : INotifyPropertyChanged {
        ...
        private int centerRectOffsetX;

        [Spinnable(1, 10), Width(100)]
        public int CenterRectOffsetX {
            get { return centerRectOffsetX; }
            set {
                centerRectOffsetX = value;
                PropertyChanged?.Invoke(this, new PropertyChangedEventArgs("CenterRectOffsetX"));
            }
        }

        private int centerRectOffsetY;

        [Spinnable(1, 10), Width(100)]
        public int CenterRectOffsetY {
            get { return centerRectOffsetY; }
            set {
                centerRectOffsetY = value;
                PropertyChanged?.Invoke(this, new PropertyChangedEventArgs("CenterRectOffsetY"));
            }
        }
